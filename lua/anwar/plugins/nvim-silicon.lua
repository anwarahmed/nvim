return {
  ...
  opts = {
    ...
    -- end,
    output = function()
      return "~/Desktop/" .. os.date("!%Y-%m-%d %H-%M-%S") .. " code.png"
    end,
  },
  init = function()
    ...
    end, { desc = "Copy file screenshot to clipboard" })
    map("n", "<leader>sf", function()
      require("nvim-silicon").file()
    end, { desc = "Save file screenshot as file" })
    map("n", "<leader>ss", function()
      require("nvim-silicon").shoot()
    end, { desc = "Create file screenshot" })
    map("v", "<leader>sc", function()
      require("nvim-silicon").clip()
    end, { desc = "Copy selection screenshot to clipboard", silent = false })
    map("v", "<leader>sf", function()
      require("nvim-silicon").file()
    end, { desc = "Save selection screenshot as file", silent = false })
    map("v", "<leader>ss", function()
      require("nvim-silicon").shoot()
    end, { desc = "Create selection screenshot", silent = false })
  end,
}
